	...
	<div  class="parallax" data-parallax="scroll" data-image-src="css/images/wimg1.jpg" style="min-height: 500px;">
		<div class="h-100 top">
			...
			<div class="col-md-12 align-self-center sticky-bottom title" >
				<label class="strike">Create New Account</label>
			</div>
		...
		<div class="h-100">
			<div class="col-md-12 pt-4 h-100 align-self-center">
				<div class="form-group col-md-6">
						<label style="font-family: 'Oswald'; color: white; font-size: 3vw; color: gray; opacity:0.6; ">Welcome to the team...</label>				
						</div>
				<form action="" method="post">
					...
					<div class="form-group">
						<select id="type" class="form-control" name="type" Required style="font-family: 'Oswald'; color: white; color: gray;border-radius: 0px;">
							<option value="" selected disabled>You are a...</option>
							<option value="Organisation">Organisation</option>
							<option value="Person">Person</option>
						</select>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="inputemail" placeholder="Email Address" style="font-family: 'Oswald'; color: white; color: gray;border-radius: 0px; " name="mail" Required>
					</div>
					<div class="container form-group col-md-9 d-flex justify-content-end " style="display:flex; justify-content:flex-end;">
						<div class="form-group col-md-6">
								<h6>Do you have any account with us? <a href="client.php">SignIn</a></h5>
						</div>
						<div class="form-group col-md-8 d-flex ml-auto align-self-center" style="display:flex; justify-content:flex-end;">
						<button type="submit" class="btn btn-dark col-md-7 " align="center" style="font-family:'Oswald'; color:white; border-radius:0px; background-color:black; height:60px; " name="submit"> <span>&nbsp;Submit&nbsp;</span></button>
					</div>
					</div>
